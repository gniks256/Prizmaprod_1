...
export const Home: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-7xl pb-20">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[65vh] md:min-h-[85vh] flex flex-col justify-center items-start mb-16 md:mb-24 lg:mb-32 overflow-hidden w-full">
        {/* Collage Background (Hidden on mobile and tablet for readability and to prevent overflow) */}
        <div className="hidden md:block absolute inset-0 z-0 opacity-40 pointer-events-none select-none overflow-hidden">
          <div className="relative w-full h-full">
            {COLLAGE_IMAGES.map((img, i) => {
              const positions = [
                ...
                { top: '55%', left: '70%', size: 'w-40 h-40 md:w-56 md:h-56', delay: 0.5, rotate: 5 },
        ...
        >
          ...
          <p className="text-zinc-600 text-sm sm:text-lg md:text-xl lg:text-2xl font-light leading-relaxed mb-8 md:mb-14 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 w-full sm:w-auto">
            <Link 
              to="/portfolio" 
              className="bg-zinc-950 text-white px-6 py-3.5 md:px-8 md:py-4 font-extrabold text-[11px] uppercase tracking-widest hover:bg-brandOrange transition-all flex items-center justify-center gap-2 rounded-lg w-full sm:w-auto text-center"
            >
              Смотреть работы <ArrowRight size={16} />
            </Link>
            <Link 
              to="/contacts" 
              className="border-2 border-zinc-950 text-zinc-950 px-6 py-3.5 md:px-8 md:py-4 font-extrabold text-[11px] uppercase tracking-widest hover:bg-zinc-950 hover:text-white transition-all rounded-lg w-full sm:w-auto text-center"
            >
              Обсудить проект
            </Link>
          </div>
      ...
      <section className="mb-24 md:mb-32 lg:mb-40">
        <div className="flex justify-between items-end mb-10 md:mb-16">
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-sans font-black uppercase tracking-tighter text-zinc-950">
              Любимые <span className="font-serif italic text-brandOrange font-normal lowercase tracking-normal">проекты</span>
            </h2>
          </div>
          <Link to="/portfolio" className="text-xs font-mono uppercase tracking-widest text-zinc-500 hover:text-brandOrange transition-colors border-b border-zinc-200 pb-1 hidden sm:block">
            Портфолио
          </Link>
        </div>
            ...
            return (
              ...
              >
                <Link to={`/project/${project.id}`} className="group block">
                  <div className="aspect-video bg-zinc-100 rounded-lg overflow-hidden mb-4 relative border border-zinc-100">
                    {videoSrc ? (
                      ...
                      <div className="w-full h-full relative">
                        <img 
                          ...
                          alt={`Превью проекта: ${project.title} - ${project.client}`} 
                  ...
                  <h3 className="text-lg font-extrabold text-zinc-950 uppercase tracking-tight mb-1 group-hover:text-brandOrange transition-colors">{project.title}</h3>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 lg:gap-16 mb-24 md:mb-32 lg:mb-40 bg-zinc-50/50 p-6 sm:p-12 md:p-16 rounded-2xl border border-zinc-100/80">
        <div className="flex flex-col gap-4 lg:gap-6">
          <div className="w-12 h-12 lg:w-14 lg:h-14 bg-brandOrange/10 text-brandOrange flex items-center justify-center rounded-xl">
            <Zap size={24} className="lg:w-6 lg:h-6" />
          </div>
          <h3 className="text-xl lg:text-2xl font-black uppercase tracking-tight text-zinc-950">Скорость</h3>
        ...
        <div className="flex flex-col gap-4 lg:gap-6">
          <div className="w-12 h-12 lg:w-14 lg:h-14 bg-brandOrange/10 text-brandOrange flex items-center justify-center rounded-xl">
            <Shield size={24} className="lg:w-6 lg:h-6" />
          </div>
          <h3 className="text-xl lg:text-2xl font-black uppercase tracking-tight text-zinc-950">Качество</h3>
          <p className="text-zinc-500 text-sm lg:text-base leading-relaxed">
        ...
        <div className="flex flex-col gap-4 lg:gap-6">
          <div className="w-12 h-12 lg:w-14 lg:h-14 bg-brandOrange/10 text-brandOrange flex items-center justify-center rounded-xl">
            <Clock size={24} className="lg:w-6 lg:h-6" />
          </div>
          <h3 className="text-xl lg:text-2xl font-black uppercase tracking-tight text-zinc-950">Опыт</h3>
          <p className="text-zinc-500 text-sm lg:text-base leading-relaxed">
      ...
      {/* CTA Section */}
      <section className="text-center py-16 sm:py-24 md:py-32 bg-zinc-950 text-white rounded-2xl relative overflow-hidden">
        <div className="relative z-10 max-w-3xl mx-auto px-6">
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-sans font-black uppercase tracking-tighter leading-none mb-8 md:mb-10 break-words">
            Готовы создать <br /> что-то <span className="font-serif italic text-brandOrange font-normal lowercase tracking-normal">особенное?</span>
          </h2>
          <p className="text-zinc-400 mb-10 md:mb-12 text-base sm:text-lg md:text-xl font-light max-w-md mx-auto">
            Оставьте заявку, и мы свяжемся с вами для обсуждения деталей вашего будущего проекта.
          </p>
          <Link 
            to="/contacts" 
            className="inline-block bg-white text-zinc-950 px-8 py-4 font-black text-xs uppercase tracking-widest hover:bg-brandOrange hover:text-white transition-all rounded-lg"
          >
            Начать проект
          </Link>
        </div>
        {/* Background decorative text */}
        <div className="absolute -bottom-10 -left-10 text-[15vw] font-black text-white/[0.02] select-none pointer-events-none leading-none uppercase tracking-tighter">
          PRIZMA
        </div>
      </section>
    </div>
