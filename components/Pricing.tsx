...
export const Pricing: React.FC = () => {
  ...
  return (
    <section className="w-full max-w-7xl pb-20">
      ...
      <h1 className="text-zinc-900 text-[1.8rem] min-[360px]:text-[2.1rem] min-[400px]:text-[2.5rem] sm:text-[4rem] md:text-[5rem] lg:text-6xl xl:text-7xl font-sans font-black uppercase tracking-tighter mb-10 md:mb-16 select-none leading-[0.85] break-words">
